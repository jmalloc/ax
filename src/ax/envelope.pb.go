...
func (*EnvelopeProto) Descriptor() ([]byte, []int) {
	return fileDescriptor_260db917093768ad, []int{0}
}
...
func init() { proto.RegisterFile("src/ax/envelope.proto", fileDescriptor_260db917093768ad) }

var fileDescriptor_260db917093768ad = []byte{
