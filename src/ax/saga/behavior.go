...
// IgnoreNotFound is an embeddable struct that implements a Saga.HandleNotFound
...
// ErrorIfNotFound is an embeddable struct that implements a Saga.HandleNotFound
// method that always returns an error.
