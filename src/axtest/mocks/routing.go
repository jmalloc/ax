...
//             HandleMessageFunc: func(ctx context.Context, mctx ax.MessageContext) error {
...
func (mock *MessageHandlerMock) HandleMessage(ctx context.Context, mctx ax.MessageContext) error {
	...
	return mock.HandleMessageFunc(ctx, mctx)
}
