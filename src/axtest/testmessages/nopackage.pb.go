...
func (*NoPackage) Descriptor() ([]byte, []int) {
	return fileDescriptor_nopackage_73b3cd5e6d565f31, []int{0}
}
...
func init() {
	proto.RegisterFile("src/axtest/testmessages/nopackage.proto", fileDescriptor_nopackage_73b3cd5e6d565f31)
}

var fileDescriptor_nopackage_73b3cd5e6d565f31 = []byte{
